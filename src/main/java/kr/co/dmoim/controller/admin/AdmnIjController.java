package kr.co.dmoim.controller.admin;

import kr.co.dmoim.dto.IjDto;
import kr.co.dmoim.dto.RpDto;
import kr.co.dmoim.dto.AttachDto;
import kr.co.dmoim.dto.SearchDto;
import kr.co.dmoim.service.IjService;
import kr.co.dmoim.service.RpService;
import kr.co.dmoim.service.AttachService;
...
//        pageable.setDirection(Sort.Direction.DESC);
    ...
    public String update(Model model, IjDto ijDto, SearchDto searchDto , String[] image, String[] imageName, String[] imageSize
        ...
        return "redirect:/admin/ij/detail.do";
    }
    ...
    public String delete(IjDto ijDto, HttpServletResponse response) throws Exception {
        ...
        return "redirect:/admin/ij/list.do";
    }
}
